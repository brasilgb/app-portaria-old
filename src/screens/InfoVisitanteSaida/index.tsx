...
const InfoVisitanteSaida = ({ route }: any) => {
            ...
            <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                <View className="bg-solar-orange-middle border border-white mx-2 mb-6 mt-2 rounded-lg py-4">
                    <View className="flex-col items-center justify-center py-2">
                        <Text className="text-lg uppercase text-solar-blue-dark font-Poppins_500Medium">Informações do visitante</Text>
                    </View>
                    <View className="flex-row items-center justify-start pt-2 border-t border-t-solar-yellow-light">
                        ...
                        <Text className="flex-1 text-base text-gray-600 font-Poppins_500Medium border-l border-solar-yellow-light pl-2">Portaria: {codeToNameOut}</Text>
                    </View>
                </View>
                ...
                <View className="mx-2 bg-white border border-gray-300 rounded-lg">
                    ...
                    <View className={`flex-row items-center justify-between border-b border-gray-300`}>
                        <Text className="flex-1 px-1 py-3 text-base font-Poppins_400Regular">Data saída</Text>
                        <Text className="flex-1 border-l px-1 py-3 border-gray-300 text-base font-Poppins_400Regular">{moment(`${visitasInfo.dataSaida}`).format("DD/MM/YYYY")}</Text>
                    </View>
                    <View className={`flex-row items-center justify-between border-b border-gray-300`}>
                    ...
                    <View className={`flex-row items-center justify-between border-b border-gray-300`}>
                        <Text className="flex-1 px-1 py-3 text-base font-Poppins_400Regular">Hora saída</Text>
                        <Text className="flex-1 border-l px-1 py-3 border-gray-300 text-base font-Poppins_400Regular">{maskHour(("0000" + visitasInfo.horaSaida).slice(-4))}</Text>
                    </View>
                    <View className={`flex-row items-center justify-between border-b border-gray-300`}>
